...
enum ForestEnum {
  ...
  ForestEnum(int id, String c, String name, Material type) {
    this(id, c, name, type, (byte)0);
  }
  ...
  ForestEnum(int id, String c, String name, Material type, byte data) {
    ...
    this.type = type;
    this.data = data;
    ForestEnumStaticClass.BY_ID.put(id, this);
  }
  ...
  public static ForestEnum getById(int id) {
    try {
      return ForestEnumStaticClass.BY_ID.get(id);
